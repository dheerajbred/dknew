...
public class CustomExoPlayerActivity extends BaseActivity<ExoVideoView> {
    ...
    protected void initView() {
        System.out.println(project.ext.compileSdkVersion);
        super.initView();
    ...
    public void onButtonClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.concat: {
                ...
                MediaSource mediaSource1 = mHelper.getMediaSource("https://node6.vidstreampng.xyz/hls/cb17a5ac69fbbdf8fe8295b401a76f83/cb17a5ac69fbbdf8fe8295b401a76f83.m3u8");
